...
const ModalProject = (prop) => {
  ...
  const onFinish = () => {
    ...
    values.id = prop.id;
    var urlCreate = "http://14.169.150.105:3001/project/create";
    var urlEdit = "http://14.169.150.105:3001/project/edit";
    axios
  ...
  const getDetailProject = (id) => {
    axios
      .post("http://14.169.150.105:3001/project/detail", { id: id })
      .then((res) => {
        form.setFieldsValue({
